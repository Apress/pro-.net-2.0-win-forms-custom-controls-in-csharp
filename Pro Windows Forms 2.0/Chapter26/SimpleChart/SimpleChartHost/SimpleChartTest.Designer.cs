namespace SimpleChartHost
{
    partial class SimpleChartTest
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.simpleChart1.Bars.Add(new SimpleChart.BarItem("Bar Item 1", 140F));
            this.simpleChart1.Bars.Add(new SimpleChart.BarItem("Bar Item 2", 80F));
            this.simpleChart1.Bars.Add(new SimpleChart.BarItem("Bar Item 3", 121F));
            this.simpleChart1.Bars.Add(new SimpleChart.BarItem("Bar Item 4", 37F));
