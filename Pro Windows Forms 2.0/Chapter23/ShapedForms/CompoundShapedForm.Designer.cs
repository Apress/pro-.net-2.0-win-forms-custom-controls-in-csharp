namespace ShapedForms
{
	partial class CompoundShapedForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Some more sample content.";
			// 
			// label2
			// 
			...
			this.label2.Text = "Some sample content.";
			// 
			// CompoundShapedForm
			// 
			...
			this.Name = "CompoundShapedForm";
			this.Text = "CompoundShapedForm";
			this.Load += new System.EventHandler(this.CompoundShapedForm_Load);
			this.Paint += new System.Windows.Forms.PaintEventHandler(this.CompoundShapedForm_Paint);
