namespace Brush
{
	partial class Menu
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "HatchBrushes";
			...
			this.button2.Text = "GradientBrushes";
			...
			this.button3.Text = "PathGradient";
			...
			this.button4.Text = "TextureBrushes";
			...
			this.ClientSize = new System.Drawing.Size(158, 156);
