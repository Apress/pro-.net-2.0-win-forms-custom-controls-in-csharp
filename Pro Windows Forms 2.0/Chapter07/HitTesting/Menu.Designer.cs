namespace HitTesting
{
	partial class Menu
	{
		...
		private void InitializeComponent()
		{
			...
			this.button3.Text = "OptimizedSquares";
			...
			this.button2.Text = "NonOptimizedSquares";
			...
			this.button1.Text = "GraphicsPathHit";
			...
			this.ClientSize = new System.Drawing.Size(171, 162);
