namespace BindingToDataSet
{
	partial class Menu
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "SimpleListBinding";
			...
			this.button2.Text = "FilteredListBinding";
			...
			this.button3.Text = "MultipleControlBinding";
			...
			this.button4.Text = "EditableBinding";
			...
			this.button7.Text = "MasterDetail";
			...
			this.button8.Text = "Unsynchronized";
			...
			this.button10.Text = "GridBinding";
			...
			this.ClientSize = new System.Drawing.Size(158, 322);
